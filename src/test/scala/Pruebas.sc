...
weightedMatchings(1,pilot,navig) // Valor esperado: List((List((1,1)),8))
...
weightedMatchings(4,navig,pilot) // Valor esperado: List((List((1,1), (2,2), (3,3), (4,4)),16), (List((1,1), (2,2), (3,4), (4,3)),30), (List((1,1), (2,3), (3,2), (4,4)),21)...
...
bestMatching(4,navig,pilot) // Valor esperado: (List((1,2), (2,1), (3,4), (4,3)),33) igual al de arriba
